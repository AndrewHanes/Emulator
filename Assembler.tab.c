...
#define IGNORE 258
#define LABEL 259
#define OPERATION 260
#define REGISTER 261
#define IMMEDIATE 262
#define ERROR 263
...
{
  "$end", "error", "$undefined", "IGNORE", "LABEL", "OPERATION",
  "REGISTER", "IMMEDIATE", "ERROR", "$accept", "program", "statement", 0
};
#endif
