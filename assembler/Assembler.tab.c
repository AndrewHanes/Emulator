...
/* Tokens.  */
#define IGNORE 258
#define OPERATION 259
#define REGISTER 260
#define IMMEDIATE 261
#define ERROR 262
#define NEWLINE 263
#define LABEL 264
#define LBLNAME 265
...
{
      12,     0,    -1,    12,    13,     8,    -1,    -1,    12,     9,
       8,    -1,    12,     3,     8,    -1,     4,     5,     5,    -1,
       4,     5,     6,    -1,     4,     5,    -1,     4,    10,    -1,
       4,    -1,     7,    -1
};
...
{
  "$end", "error", "$undefined", "IGNORE", "OPERATION", "REGISTER",
  "IMMEDIATE", "ERROR", "NEWLINE", "LABEL", "LBLNAME", "$accept",
  "program", "statement", 0
};
#endif
...
{
       2,     9,     8,     3,     4,    11,    10,     5,     0,     6,
      13,    14,    12
};

static const yytype_int8 yycheck[] =
{
       0,     5,     8,     3,     4,     8,    10,     7,    -1,     9,
       5,     6,     8
};
...
#line 55 "Assembler.y"
    {
		...
		if(runNum == 1) {
			...
			ptr->label = (yyvsp[(2) - (3)].label).label;
			ptr->address = addr;
